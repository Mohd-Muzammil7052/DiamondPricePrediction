...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            # Define which columns should be ordinal-endcode and which should be scaled
    ...
    def initiate_data_transformation(self,train_data_path,test_data_path):
        try:
            ...
            input_feature_train_df = train_df.drop(train_df.columns[6],axis=1)
            target_feature_train_df = train_df[train_df.columns[6]]

            input_feature_test_df = test_df.drop(test_df.columns[6],axis=1)
            target_feature_test_df = test_df[test_df.columns[6]]
